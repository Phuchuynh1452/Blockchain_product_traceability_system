...
<head>
    ...
    <!-- fevicon -->
    <link rel="icon" href="/honey-html/images/fevicon.png" type="image/gif" />
...
<!-- loader  -->
<div class="loader_bg">
    <div class="loader"><img src="/honey-html/images/fail.gif" alt="#"/></div>
</div>
<!-- end loader -->
<!-- header -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="titlepage text_align_center">
                    <h1><img width="300px" src="/honey-html/images/warning.jpg" alt="#"/></h1>
                    <br>
